<?php
	...
	if(isset($_GET['comeid']) && !empty($_GET['comeid']))
	{
		$id = $_GET['comeid'];
		$stmt_edit = $DB_con->prepare('SELECT * FROM come WHERE comeid=:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		$following+=1;
		$total=0;
			$stmt = $DB_con->prepare('UPDATE come
									     SET  total=:tt,following=:ff
								       WHERE comeid=:uid');
			$stmt->bindParam(':tt',$total);
			$stmt->bindParam(':ff',$following);
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="following" value="<?php echo $following; ?>" required /></td>
    </tr>
